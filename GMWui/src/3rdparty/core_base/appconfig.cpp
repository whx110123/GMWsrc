...
/*[TcpClientConfig]*/
bool AppConfig::HexSendTcpClient = true;
bool AppConfig::HexReceiveTcpClient = true;
...
QString AppConfig::TcpBindIP = "默认";
int AppConfig::TcpBindPort = 6001;
QString AppConfig::TcpServerIP = "127.0.0.1";
int AppConfig::TcpServerPort = 6000;
/*[TcpServerConfig]*/
bool AppConfig::HexSendTcpServer = true;
bool AppConfig::HexReceiveTcpServer = true;
...
/*[UdpClientConfig]*/
bool AppConfig::HexSendUdpClient = true;
bool AppConfig::HexReceiveUdpClient = true;
...
/*[UdpServerConfig]*/
bool AppConfig::HexSendUdpServer = true;
bool AppConfig::HexReceiveUdpServer = true;
...
QString AppConfig::Parity = "无";
double AppConfig::StopBit = 1;
bool AppConfig::HexSend = true;
bool AppConfig::HexReceive = true;
